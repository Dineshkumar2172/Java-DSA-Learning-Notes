...
public class Dijkstra {
    public void executeDijkstra(int vertex, List<List<Integer[]>> adjList) {
        int n = adjList.size();
        ...
        while (!pq.isEmpty()) {
            ...
            for (Integer[] neighbor: adjList.get(currentVertex)) {
                ...
                if (shortestPath[currentVertex] + neighborWeight < shortestPath[neighborVertex]) {
                    shortestPath[neighborVertex] = shortestPath[currentVertex] + neighborWeight;
